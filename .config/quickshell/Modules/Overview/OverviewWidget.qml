                    ...
                    MouseArea {
                        ...
                        onReleased: {
                            ...
                            if (targetWorkspace !== -1 && targetWorkspace !== windowData?.workspace.id) {
                                Hyprland.dispatch(`hl.dsp.window.move({ workspace = ${targetWorkspace}, follow = false, window = ${LuaUtils.stringLiteral(`address:${window.windowData?.address}`)} })`)
                        ...
                        onClicked: (event) => {
                            ...
                            if (event.button === Qt.LeftButton) {
                                ...
                                Hyprland.dispatch(`hl.dsp.window.close({ window = ${LuaUtils.stringLiteral(`address:${windowData.address}`)} })`)
                                event.accepted = true
                            }
                        }
