...
Item {
    ...
    // Recolours the indicator to signal a rejected change, e.g. the volume limit
    property bool alert: false
    readonly property color accentColor: root.alert ? Appearance.m3colors.m3error : Appearance.colors.colPrimary
        ...
        RowLayout { // Icon on the left, stuff on the right
            ...
            Item {
                ...
                MaterialSymbol { // Icon
                    ...
                    color: root.alert ? root.accentColor : Appearance.colors.colOnLayer0
