...
Rectangle {
    ...
    property var tabs: [
        ...
        {"type": "todo", "name": "Notes", "icon": "note", "widget": todoWidget}
    ]
    ...
    RowLayout {
        ...
        StyledText {
            property int noteCount: Todo.list.length;
            Layout.margins: 10
            Layout.leftMargin: 0
            text: `${DateTime.collapsedCalendarFormat}   •   ${noteCount} note${noteCount !== 1 ? "s" : ""}`
