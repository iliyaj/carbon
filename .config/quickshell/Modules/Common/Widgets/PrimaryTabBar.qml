            ...
            property real targetWidth: {
                try {
                    if (tabBar.contentItem &&
                        tabBar.contentItem.children &&
                        tabBar.contentItem.children.length > 0 &&
                        tabBar.contentItem.children[0].children &&
                        tabBar.currentIndex >= 0 &&
                        tabBar.currentIndex < tabBar.contentItem.children[0].children.length &&
                        tabBar.contentItem.children[0].children[tabBar.currentIndex] &&
                        tabBar.contentItem.children[0].children[tabBar.currentIndex].tabContentWidth !== undefined) {
                        return tabBar.contentItem.children[0].children[tabBar.currentIndex].tabContentWidth;
                    }
                } catch (e) {}
                return fullTabSize;
            }
