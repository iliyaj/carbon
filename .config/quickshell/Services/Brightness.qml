...
Singleton {
    ...
    component BrightnessMonitor: QtObject {
        ...
        readonly property bool isDdc: screen != null ? root.ddcMonitors.some(m => m.model === screen.model) : false
        readonly property string busNum: screen != null ? (root.ddcMonitors.find(m => m.model === screen.model)?.busNum ?? "") : ""
